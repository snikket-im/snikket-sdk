...
class borogove_DirectChat extends borogove_Chat {
	...
	sendMessage(message) {
		...
		case 3:
			...
			break;
		default:
			haxe_Log.trace("Invalid message",{ fileName : "borogove/Chat.hx", lineNumber : 1076, className : "borogove.DirectChat", methodName : "sendMessage", customParams : [fromStanza]});
...
class borogove_Channel extends borogove_Chat {
		...
		(refresh ? $bind(this,this.refreshDisco) : function(cb) {
			...
			_gthis.stream.sendIq(new borogove_Stanza("iq",{ type : "get", to : _gthis.getFullJid().asString()}).tag("ping",{ xmlns : "urn:xmpp:ping"}).up(),function(response) {
				if(response.attr["type"] == "error") {
					...
					haxe_Log.trace("SYNC: self-ping fail, join",{ fileName : "borogove/Chat.hx", lineNumber : 1287, className : "borogove.Channel", methodName : "selfPing", customParams : [_gthis.chatId]});
					_gthis.join();
				} else {
					_gthis.selfPingSuccess();
				}
	...
	doSync(lastId) {
		...
		this.sync.onError(function(stanza) {
			...
			if(lastId != null) {
				...
				haxe_Log.trace("SYNC failed",{ fileName : "borogove/Chat.hx", lineNumber : 1522, className : "borogove.Channel", methodName : "doSync", customParams : [_gthis.chatId,stanza]});
			}
		});
		this.sync.fetchNext();
	}
	...
	sendMessage(message) {
		...
		case 3:
			...
			break;
		default:
			haxe_Log.trace("Invalid message",{ fileName : "borogove/Chat.hx", lineNumber : 1734, className : "borogove.Channel", methodName : "sendMessage", customParams : [fromStanza]});
			throw haxe_Exception.thrown("Trying to send invalid message.");
		}
	}
	removeReaction(m,reaction) {
...
class borogove_Client extends borogove_EventEmitter {
	...
	_hx_constructor(accountId,persistence) {
		...
		this.stream.onIq(borogove_IqRequestType.Set,"jingle","urn:xmpp:jingle:1",function(stanza) {
			...
			if(jingle.attr["action"] == "session-initiate") {
				if(session != null) {
					try {
						...
						haxe_Log.trace("Bad session-inititate",{ fileName : "borogove/Client.hx", lineNumber : 224, className : "borogove.Client", methodName : "new", customParams : [_g1]});
			...
			if(session != null && jingle.attr["action"] == "session-accept") {
				try {
					...
					let _g1 = haxe_Exception.caught(_g);
					haxe_Log.trace("session-accept failed",{ fileName : "borogove/Client.hx", lineNumber : 239, className : "borogove.Client", methodName : "new", customParams : [_g1]});
				}
			}
		...
		this.stream.on("presence",function(event) {
			...
			if(stanza.attr["from"] != null && stanza.attr["type"] == null) {
				...
				if(chat == null) {
					haxe_Log.trace("Presence for unknown JID: " + stanza.attr["from"],{ fileName : "borogove/Client.hx", lineNumber : 341, className : "borogove.Client", methodName : "new"});
					return borogove_EventResult.EventUnhandled;
				}
			...
			if(stanza.attr["from"] != null && stanza.attr["type"] == "unavailable") {
				...
				if(chat == null) {
					haxe_Log.trace("Presence for unknown JID: " + stanza.attr["from"],{ fileName : "borogove/Client.hx", lineNumber : 413, className : "borogove.Client", methodName : "new"});
					return borogove_EventResult.EventUnhandled;
				}
	...
	processLiveMessage(stanza,fwd,encryptionInfo) {
		...
		case 4:
			...
			break;
		default:
			haxe_Log.trace("Ignoring non-chat message: " + stanza.toString(),{ fileName : "borogove/Client.hx", lineNumber : 496, className : "borogove.Client", methodName : "processLiveMessage"});
		}
		...
		if(jmiPro != null && jmiPro.attr["id"] != null) {
			...
			if(session != null) {
				try {
					...
					let _g1 = haxe_Exception.caught(_g);
					haxe_Log.trace("JMI proceed failed",{ fileName : "borogove/Client.hx", lineNumber : 540, className : "borogove.Client", methodName : "processLiveMessage", customParams : [_g1]});
				}
			}
		}
		...
		haxe_Log.trace("pubsubEvent " + Std.string(pubsubEvent != null),{ fileName : "borogove/Client.hx", lineNumber : 611, className : "borogove.Client", methodName : "processLiveMessage"});
		if(pubsubEvent != null && pubsubEvent.getFrom() != null) {
			...
			haxe_Log.trace("pubsubNode == " + pubsubNode,{ fileName : "borogove/Client.hx", lineNumber : 638, className : "borogove.Client", methodName : "processLiveMessage"});
		}
	}
	start() {
	...
	onConnected(data) {
		...
		this.rosterGet();
		haxe_Log.trace("SYNC: bookmarks",{ fileName : "borogove/Client.hx", lineNumber : 830, className : "borogove.Client", methodName : "onConnected"});
		this.bookmarksGet(function() {
			haxe_Log.trace("SYNC: MAM",{ fileName : "borogove/Client.hx", lineNumber : 832, className : "borogove.Client", methodName : "onConnected"});
			_gthis.sync(function(syncFinished) {
				if(!syncFinished) {
					haxe_Log.trace("SYNC: failed",{ fileName : "borogove/Client.hx", lineNumber : 835, className : "borogove.Client", methodName : "onConnected"});
					_gthis.inSync = false;
					_gthis.stream.disconnect();
					return;
				}
				haxe_Log.trace("SYNC: details",{ fileName : "borogove/Client.hx", lineNumber : 842, className : "borogove.Client", methodName : "onConnected"});
				_gthis.inSync = true;
				thenshim_Promise.then(_gthis.persistence.getChatsUnreadDetails(_gthis.accountId(),_gthis.chats),function(details) {
					...
					haxe_Log.trace("SYNC: done",{ fileName : "borogove/Client.hx", lineNumber : 868, className : "borogove.Client", methodName : "onConnected"});
				});
			});
		});
			...
			return thenshim_Promise._new(function(resolve,reject) {
				tink_io_Source.chunked(new tink_io_js_BlobSource(source.name,source,0,16777216)).forEach(tink_streams_Handler.ofSafeSync(function(chunk) {
					...
					if(o._hx_index == 3) {
						...
						haxe_Log.trace("Error computing attachment hash",{ fileName : "borogove/Client.hx", lineNumber : 895, className : "borogove.Client", methodName : "prepareAttachment", customParams : [o]});
						reject(o);
					}
				});
			});
	...
	prepareAttachmentFor(source,services,hashes,callback) {
		if(services.length < 1) {
			haxe_Log.trace("No HTTP upload service found",{ fileName : "borogove/Client.hx", lineNumber : 904, className : "borogove.Client", methodName : "prepareAttachmentFor"});
			callback(null);
			return;
		}
		...
		httpUploadSlot.onFinished(function() {
			...
			if(slot == null) {
				...
				tink_http_FetchResponse.all(tink_http_Fetch.fetch(tink_Url.fromString(slot.put),{ method : "PUT", headers : slot.putHeaders.concat([new tink_http_HeaderField("Content-Length".toLowerCase(),tink_http_HeaderValue.ofInt(source.size))]), body : tink_io_RealSourceTools.idealize(new tink_io_js_BlobSource(source.name,source,0,16777216),function(e) {
					haxe_Log.trace("WUT",{ fileName : "borogove/Client.hx", lineNumber : 914, className : "borogove.Client", methodName : "prepareAttachmentFor", customParams : [e]});
		...
		window.crypto.subtle.exportKey("raw",vapid_key.publicKey).then(function(vapid_public_raw) {
			return reg.pushManager.subscribe({ userVisibleOnly : true, applicationServerKey : vapid_public_raw}).then(function(pushSubscription) {
				if(pushSubscription == null) {
					haxe_Log.trace("WebPush subscription failed",{ fileName : "borogove/Client.hx", lineNumber : 1134, className : "borogove.Client", methodName : "subscribePush"});
					return;
				}
	...
	doSync(callback,lastId) {
		...
		sync.onMessages(function(messageList) {
			...
			haxe_Log.trace("SYNC: MAM page wait for writes",{ fileName : "borogove/Client.hx", lineNumber : 1832, className : "borogove.Client", methodName : "doSync"});
			thenshim_Promise.then(thenshim_PromiseTools.all(promises),function(results) {
				...
				haxe_Log.trace("SYNC: error",{ fileName : "borogove/Client.hx", lineNumber : 1859, className : "borogove.Client", methodName : "doSync", customParams : [e == null ? "null" : Std.string(e)]});
				callback(false);
			});
		});
		sync.onError(function(stanza) {
			if(lastId != null) {
				...
				haxe_Log.trace("SYNC: error",{ fileName : "borogove/Client.hx", lineNumber : 1868, className : "borogove.Client", methodName : "doSync", customParams : [stanza]});
				if(callback != null) {
					callback(false);
				}
			}
...
class borogove_streams_XmppJsStream extends borogove_GenericStream {
	...
	enableDebug() {
		this.debug = true;
		if(this.client != null) {
			borogove_streams_XmppJsDebug(this.client,true);
		}
	}
	register(domain,preAuth) {
		...
		return new Promise(function(resolve,reject) {
			...
			_gthis.client.start().catch(function(err) {
				haxe_Log.trace(err,{ fileName : "borogove/streams/XmppJsStream.hx", lineNumber : 233, className : "borogove.streams.XmppJsStream", methodName : "register"});
				reject(err);
			});
		});
	}
	connect(jidS,sm) {
		...
		xmpp.start().catch(function(err) {
			...
			if((xmppError != null ? xmppError.name : null) == "SASLError") {
				...
				haxe_Log.trace(err,{ fileName : "borogove/streams/XmppJsStream.hx", lineNumber : 369, className : "borogove.streams.XmppJsStream", methodName : "connect"});
			}
		});
	}
	disconnect() {
...
borogove_Version.HUMAN = "564de9a";
