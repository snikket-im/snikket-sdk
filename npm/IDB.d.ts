declare function _default(dbname: any, media: any, tokenize: any, stemmer: any): Promise<{
    ...
    getMessage: (account: any, chatId: any, serverId: any, localId: any) => Promise<borogove.ChatMessage>;
    storeReaction: (account: any, update: any) => Promise<borogove.ChatMessage>;
    ...
    updateMessageStatus: (account: any, localId: any, status: any) => Promise<borogove.ChatMessage>;
    getMessagesBefore: (account: any, chatId: any, beforeId: any, beforeTime: any) => Promise<borogove.ChatMessage[]>;
    getMessagesAfter: (account: any, chatId: any, afterId: any, afterTime: any) => Promise<borogove.ChatMessage[]>;
    getMessagesAround: (account: any, chatId: any, id: any, timeArg: any) => Promise<borogove.ChatMessage[]>;
    getMessagesFromCursor: (cursor: any, id: any, bound: any) => Promise<borogove.ChatMessage[]>;
    ...
    getCaps: (ver: any) => Promise<borogove.Caps>;
