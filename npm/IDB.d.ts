declare function _default(dbname: any, media: any, tokenize: any, stemmer: any): Promise<{
    syncPoint: (account: any, chatId: any) => Promise<import("./borogove.js").borogove_ChatMessage>;
    storeChats: (account: any, chats: any) => void;
    getChats: (account: any) => Promise<any[]>;
    storeMembers(account: any, chatId: any, members: any): Promise<boolean>;
    storeMemberUpdates(account: any, chat: any, updates: any, isFullList: any): Promise<any[]>;
    clearMemberPresence(account: any, chatId: any): Promise<boolean>;
    getMembers(account: any, chat: any, forModerator: any): Promise<any[]>;
    getMemberDetails(account: any, chat: any, ids: any): Promise<any[]>;
    getChatUnreadDetails: (account: any, chat: any) => Promise<{
        message: import("./borogove.js").borogove_ChatMessage;
        unreadCount: number;
    }>;
    ...
    getMessagesBefore: (account: any, chatId: any, before: any) => Promise<import("./borogove.js").borogove_ChatMessage[]>;
    getMessagesAfter: (account: any, chatId: any, after: any) => Promise<import("./borogove.js").borogove_ChatMessage[]>;
    getMessagesAround: (account: any, around: any) => Promise<import("./borogove.js").borogove_ChatMessage[]>;
    getMessagesFromCursor: (cursor: any, notIncluding: any, filter: any) => Promise<import("./borogove.js").borogove_ChatMessage[]>;
    searchMessages: (account: any, chatId: any, q: any) => Promise<import("./borogove.js").borogove_ChatMessage[]>;
    hasMedia: (hashAlgorithm: any, hash: any) => any;
    removeMedia: (hashAlgorithm: any, hash: any) => any;
    storeMedia: (mime: any, buffer: any) => any;
    storeCaps: (caps: any) => void;
    getCaps: (ver: any) => Promise<borogove_Caps>;
    storeLogin(login: any, clientId: any, displayName: any, token: any): Promise<boolean>;
    ...
    storeStreamManagement(account: any, sm: any, sortId: any): Promise<boolean>;
    getStreamManagement(account: any): Promise<{
        sm: any;
        sortId: any;
    }>;
    ...
    removeAccount(account: any, completely: any): Promise<boolean>;
