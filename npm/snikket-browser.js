...
class snikket_streams_XmppJsStream extends snikket_GenericStream {
	...
	connectWithURI(uri) {
		haxe_Log.trace("Got connection URI: " + uri,{ fileName : "snikket/streams/XmppJsStream.hx", lineNumber : 157, className : "snikket.streams.XmppJsStream", methodName : "connectWithURI"});
		if(uri == null) {
		...
		snikket_streams_XmppJsScramSha1(xmpp.sasl2);
		...
		xmpp.start().catch(function(err) {
			...
			if((xmppError != null ? xmppError.name : null) == "SASLError") {
				...
				haxe_Log.trace(err,{ fileName : "snikket/streams/XmppJsStream.hx", lineNumber : 276, className : "snikket.streams.XmppJsStream", methodName : "connectWithURI"});
			}
		});
	}
	connect(jid,sm) {
