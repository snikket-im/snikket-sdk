...
class snikket_DirectChat extends snikket_Chat {
	...
	sendMessage(message) {
		...
		case 2:
			...
			break;
		default:
			haxe_Log.trace("Invalid message",{ fileName : "snikket/Chat.hx", lineNumber : 758, className : "snikket.DirectChat", methodName : "sendMessage", customParams : [fromStanza]});
...
class snikket_Channel extends snikket_Chat {
	...
	sendMessage(message) {
		...
		case 2:
			...
			break;
		default:
			haxe_Log.trace("Invalid message",{ fileName : "snikket/Chat.hx", lineNumber : 1184, className : "snikket.Channel", methodName : "sendMessage", customParams : [fromStanza]});
			throw haxe_Exception.thrown("Trying to send invalid message.");
		}
	}
	removeReaction(m,reaction) {
...
class snikket_Client extends snikket_EventEmitter {
	...
	_hx_constructor(address,persistence) {
			...
			if(jmiPro != null && jmiPro.attr["id"] != null) {
				...
				if(session != null) {
					try {
						...
						haxe_Log.trace("JMI proceed failed",{ fileName : "snikket/Client.hx", lineNumber : 221, className : "snikket.Client", methodName : "new", customParams : [e]});
					}
				}
			}
		...
		this.stream.onIq(snikket_IqRequestType.Set,"jingle","urn:xmpp:jingle:1",function(stanza) {
			...
			if(jingle.attr["action"] == "session-initiate") {
				if(session != null) {
					try {
						...
						let e = haxe_Exception.caught(_g);
						haxe_Log.trace("Bad session-inititate",{ fileName : "snikket/Client.hx", lineNumber : 325, className : "snikket.Client", methodName : "new", customParams : [e]});
						chat.jingleSessions.delete(session.get_sid());
					}
				} else {
			...
			if(session != null && jingle.attr["action"] == "session-accept") {
				try {
					...
					let e = haxe_Exception.caught(_g);
					haxe_Log.trace("session-accept failed",{ fileName : "snikket/Client.hx", lineNumber : 340, className : "snikket.Client", methodName : "new", customParams : [e]});
				}
			}
		...
		this.stream.on("presence",function(event) {
			...
			if(stanza.attr["from"] != null && stanza.attr["type"] == null) {
				...
				let chat = _gthis.getChat(from.asBare().asString());
				if(chat == null) {
					haxe_Log.trace("Presence for unknown JID: " + stanza.attr["from"],{ fileName : "snikket/Client.hx", lineNumber : 439, className : "snikket.Client", methodName : "new"});
					return snikket_EventResult.EventUnhandled;
				}
				if(c == null) {
			...
			if(stanza.attr["from"] != null && stanza.attr["type"] == "unavailable") {
				...
				if(chat == null) {
					haxe_Log.trace("Presence for unknown JID: " + stanza.attr["from"],{ fileName : "snikket/Client.hx", lineNumber : 509, className : "snikket.Client", methodName : "new"});
					return snikket_EventResult.EventUnhandled;
				}
	...
	onConnected(data) {
		...
		this.rosterGet();
		haxe_Log.trace("SYNC: bookmarks",{ fileName : "snikket/Client.hx", lineNumber : 663, className : "snikket.Client", methodName : "onConnected"});
		this.bookmarksGet(function() {
			haxe_Log.trace("SYNC: MAM",{ fileName : "snikket/Client.hx", lineNumber : 665, className : "snikket.Client", methodName : "onConnected"});
			_gthis.sync(function(syncFinished) {
				if(!syncFinished) {
					haxe_Log.trace("SYNC: failed",{ fileName : "snikket/Client.hx", lineNumber : 668, className : "snikket.Client", methodName : "onConnected"});
					_gthis.inSync = false;
					_gthis.stream.disconnect();
					return;
				}
				haxe_Log.trace("SYNC: details",{ fileName : "snikket/Client.hx", lineNumber : 675, className : "snikket.Client", methodName : "onConnected"});
				_gthis.inSync = true;
				_gthis.persistence.getChatsUnreadDetails(_gthis.accountId(),_gthis.chats,function(details) {
					let _g = 0;
					while(_g < details.length) {
					...
					haxe_Log.trace("SYNC: done",{ fileName : "snikket/Client.hx", lineNumber : 695, className : "snikket.Client", methodName : "onConnected"});
				});
			});
		});
		return snikket_EventResult.EventHandled;
		...
		this.persistence.findServicesWithFeature(this.accountId(),"urn:xmpp:http:upload:0",function(services) {
			...
			tink_io_Source.chunked(new tink_io_js_BlobSource(source.name,source,0,chunkSize)).forEach(tink_streams_Handler.ofSafeSync(function(chunk) {
				...
				if(o._hx_index == 3) {
					...
					haxe_Log.trace("Error computing attachment hash",{ fileName : "snikket/Client.hx", lineNumber : 716, className : "snikket.Client", methodName : "prepareAttachment", customParams : [o]});
					callback(null);
				}
			});
		});
	...
	serverBlocked(blocked) {
		let chat = this.getChat(blocked);
		if(chat == null) {
			this.startChatWith(blocked,function(caps) {
				return 2;
			},function(chat) {
		...
		sync.onMessages(function(messageList) {
			...
			while(_g < _g1.length) {
				...
				case 2:
					let update = m.update;
					promises.push(thenshim_Promise._new(function(resolve,reject) {
						_gthis.persistence.storeReaction(_gthis.accountId(),update,resolve);
					}));
					break;
				default:
				}
			}
			haxe_Log.trace("SYNC: MAM page wait for writes",{ fileName : "snikket/Client.hx", lineNumber : 1366, className : "snikket.Client", methodName : "doSync"});
			thenshim_Promise.then(thenshim_PromiseTools.all(promises),function(_) {
				if(sync.hasMore()) {
					sync.fetchNext();
				} else {
				...
				haxe_Log.trace("SYNC: error",{ fileName : "snikket/Client.hx", lineNumber : 1378, className : "snikket.Client", methodName : "doSync", customParams : [e == null ? "null" : Std.string(e)]});
				callback(false);
			});
		});
		sync.onError(function(stanza) {
			if(lastId != null) {
				...
				haxe_Log.trace("SYNC: error",{ fileName : "snikket/Client.hx", lineNumber : 1387, className : "snikket.Client", methodName : "doSync", customParams : [stanza]});
				if(callback != null) {
					callback(false);
				}
			}
