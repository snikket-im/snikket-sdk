...
import borogove_streams_XmppJsTcp from "@xmpp/tcp";
import borogove_streams_XmppJsSTARTTLS from "@xmpp/starttls";
...
class borogove_DirectChat extends borogove_Chat {
	...
	sendMessage(message) {
		...
		case 3:
			...
			break;
		default:
			haxe_Log.trace("Invalid message",{ fileName : "borogove/Chat.hx", lineNumber : 933, className : "borogove.DirectChat", methodName : "sendMessage", customParams : [fromStanza]});
...
class borogove_Channel extends borogove_Chat {
		...
		(refresh ? $bind(this,this.refreshDisco) : function(cb) {
			...
			_gthis.stream.sendIq(new borogove_Stanza("iq",{ type : "get", to : _gthis.getFullJid().asString()}).tag("ping",{ xmlns : "urn:xmpp:ping"}).up(),function(response) {
				if(response.attr["type"] == "error") {
					...
					haxe_Log.trace("SYNC: self-ping fail, join",{ fileName : "borogove/Chat.hx", lineNumber : 1099, className : "borogove.Channel", methodName : "selfPing", customParams : [_gthis.chatId]});
					_gthis.join();
				} else {
					_gthis.selfPingSuccess();
				}
	...
	doSync(lastId) {
		...
		this.sync.onMessages(function(messageList) {
			...
			thenshim_Promise.then(thenshim_PromiseTools.all(promises),function(stored) {
				...
				if(_gthis.sync.hasMore()) {
					...
					_gthis.inSync = true;
					_gthis.sync = null;
					chatMessages.sort(function(x,y) {
		...
		this.sync.onError(function(stanza) {
			...
			if(lastId != null) {
				...
				haxe_Log.trace("SYNC failed",{ fileName : "borogove/Chat.hx", lineNumber : 1284, className : "borogove.Channel", methodName : "doSync", customParams : [_gthis.chatId,stanza]});
			}
		});
		this.sync.fetchNext();
	}
	...
	sendMessage(message) {
		...
		case 3:
			...
			break;
		default:
			haxe_Log.trace("Invalid message",{ fileName : "borogove/Chat.hx", lineNumber : 1487, className : "borogove.Channel", methodName : "sendMessage", customParams : [fromStanza]});
			throw haxe_Exception.thrown("Trying to send invalid message.");
		}
	}
	removeReaction(m,reaction) {
...
class borogove_Client extends borogove_EventEmitter {
	...
	_hx_constructor(accountId,persistence) {
		...
		this.stream.onIq(borogove_IqRequestType.Set,"jingle","urn:xmpp:jingle:1",function(stanza) {
			...
			if(jingle.attr["action"] == "session-initiate") {
				if(session != null) {
					try {
						...
						haxe_Log.trace("Bad session-inititate",{ fileName : "borogove/Client.hx", lineNumber : 216, className : "borogove.Client", methodName : "new", customParams : [_g1]});
			...
			if(session != null && jingle.attr["action"] == "session-accept") {
				try {
					...
					let _g1 = haxe_Exception.caught(_g);
					haxe_Log.trace("session-accept failed",{ fileName : "borogove/Client.hx", lineNumber : 231, className : "borogove.Client", methodName : "new", customParams : [_g1]});
				}
			}
		...
		this.stream.on("presence",function(event) {
			...
			if(stanza.attr["from"] != null && stanza.attr["type"] == null) {
				...
				if(chat == null) {
					haxe_Log.trace("Presence for unknown JID: " + stanza.attr["from"],{ fileName : "borogove/Client.hx", lineNumber : 333, className : "borogove.Client", methodName : "new"});
					return borogove_EventResult.EventUnhandled;
				}
			...
			if(stanza.attr["from"] != null && stanza.attr["type"] == "unavailable") {
				...
				if(chat == null) {
					haxe_Log.trace("Presence for unknown JID: " + stanza.attr["from"],{ fileName : "borogove/Client.hx", lineNumber : 405, className : "borogove.Client", methodName : "new"});
					return borogove_EventResult.EventUnhandled;
				}
	...
	processLiveMessage(stanza,fwd,encryptionInfo) {
		...
		case 3:
			...
			break;
		default:
			haxe_Log.trace("Ignoring non-chat message: " + stanza.toString(),{ fileName : "borogove/Client.hx", lineNumber : 465, className : "borogove.Client", methodName : "processLiveMessage"});
		}
		...
		if(jmiPro != null && jmiPro.attr["id"] != null) {
			...
			if(session != null) {
				try {
					...
					let _g1 = haxe_Exception.caught(_g);
					haxe_Log.trace("JMI proceed failed",{ fileName : "borogove/Client.hx", lineNumber : 509, className : "borogove.Client", methodName : "processLiveMessage", customParams : [_g1]});
				}
			}
		}
		...
		haxe_Log.trace("pubsubEvent " + Std.string(pubsubEvent != null),{ fileName : "borogove/Client.hx", lineNumber : 580, className : "borogove.Client", methodName : "processLiveMessage"});
		if(pubsubEvent != null && pubsubEvent.getFrom() != null) {
			...
			haxe_Log.trace("pubsubNode == " + pubsubNode,{ fileName : "borogove/Client.hx", lineNumber : 607, className : "borogove.Client", methodName : "processLiveMessage"});
		}
	}
	start() {
	...
	onConnected(data) {
		...
		this.rosterGet();
		haxe_Log.trace("SYNC: bookmarks",{ fileName : "borogove/Client.hx", lineNumber : 778, className : "borogove.Client", methodName : "onConnected"});
		this.bookmarksGet(function() {
			haxe_Log.trace("SYNC: MAM",{ fileName : "borogove/Client.hx", lineNumber : 780, className : "borogove.Client", methodName : "onConnected"});
			_gthis.sync(function(syncFinished) {
				if(!syncFinished) {
					haxe_Log.trace("SYNC: failed",{ fileName : "borogove/Client.hx", lineNumber : 783, className : "borogove.Client", methodName : "onConnected"});
					_gthis.inSync = false;
					_gthis.stream.disconnect();
					return;
				}
				haxe_Log.trace("SYNC: details",{ fileName : "borogove/Client.hx", lineNumber : 790, className : "borogove.Client", methodName : "onConnected"});
				_gthis.inSync = true;
				thenshim_Promise.then(_gthis.persistence.getChatsUnreadDetails(_gthis.accountId(),_gthis.chats),function(details) {
					...
					haxe_Log.trace("SYNC: done",{ fileName : "borogove/Client.hx", lineNumber : 816, className : "borogove.Client", methodName : "onConnected"});
				});
			});
		});
			...
			return thenshim_Promise._new(function(resolve,reject) {
				tink_io_Source.chunked(new tink_io_js_BlobSource(source.name,source,0,16777216)).forEach(tink_streams_Handler.ofSafeSync(function(chunk) {
					...
					if(o._hx_index == 3) {
						...
						haxe_Log.trace("Error computing attachment hash",{ fileName : "borogove/Client.hx", lineNumber : 843, className : "borogove.Client", methodName : "prepareAttachment", customParams : [o]});
						reject(o);
					}
				});
			});
	...
	prepareAttachmentFor(source,services,hashes,callback) {
		if(services.length < 1) {
			haxe_Log.trace("No HTTP upload service found",{ fileName : "borogove/Client.hx", lineNumber : 852, className : "borogove.Client", methodName : "prepareAttachmentFor"});
			callback(null);
			return;
		}
		...
		httpUploadSlot.onFinished(function() {
			...
			if(slot == null) {
				...
				tink_http_FetchResponse.all(tink_http_Fetch.fetch(tink_Url.fromString(slot.put),{ method : "PUT", headers : slot.putHeaders.concat([new tink_http_HeaderField("Content-Length".toLowerCase(),tink_http_HeaderValue.ofInt(source.size))]), body : tink_io_RealSourceTools.idealize(new tink_io_js_BlobSource(source.name,source,0,16777216),function(e) {
					haxe_Log.trace("WUT",{ fileName : "borogove/Client.hx", lineNumber : 862, className : "borogove.Client", methodName : "prepareAttachmentFor", customParams : [e]});
		...
		window.crypto.subtle.exportKey("raw",vapid_key.publicKey).then(function(vapid_public_raw) {
			return reg.pushManager.subscribe({ userVisibleOnly : true, applicationServerKey : vapid_public_raw}).then(function(pushSubscription) {
				if(pushSubscription == null) {
					haxe_Log.trace("WebPush subscription failed",{ fileName : "borogove/Client.hx", lineNumber : 1075, className : "borogove.Client", methodName : "subscribePush"});
					return;
				}
	...
	addChatsUpdatedListener(handler) {
		...
		return this.on("chats/update",function(data) {
			...
			let now = (hrtime[0] + hrtime[1] / 1e9) * 1000;
			...
			if(lastCall < 0 || now - lastCall >= 500) {
				...
				updateChatTimer = haxe_Timer.delay(function() {
					let hrtime = process.hrtime();
					lastCall = (hrtime[0] + hrtime[1] / 1e9) * 1000;
					let _e = updateChatBuffer;
					handler(Lambda.array({ iterator : function() {
						return new js_lib_HaxeIterator(_e.values());
					}}));
	...
	doSync(callback,lastId) {
		...
		sync.onMessages(function(messageList) {
			...
			haxe_Log.trace("SYNC: MAM page wait for writes",{ fileName : "borogove/Client.hx", lineNumber : 1702, className : "borogove.Client", methodName : "doSync"});
			thenshim_Promise.then(thenshim_PromiseTools.all(promises),function(results) {
				...
				haxe_Log.trace("SYNC: error",{ fileName : "borogove/Client.hx", lineNumber : 1729, className : "borogove.Client", methodName : "doSync", customParams : [e == null ? "null" : Std.string(e)]});
				callback(false);
			});
		});
		sync.onError(function(stanza) {
			if(lastId != null) {
				...
				haxe_Log.trace("SYNC: error",{ fileName : "borogove/Client.hx", lineNumber : 1738, className : "borogove.Client", methodName : "doSync", customParams : [stanza]});
				if(callback != null) {
					callback(false);
				}
			}
...
class borogove_DataForm {
	...
	static field(this1,name) {
		...
		if(_g.length > 1) {
			haxe_Log.trace("Multiple fields matching " + name,{ fileName : "borogove/DataForm.hx", lineNumber : 25, className : "borogove._DataForm.DataForm_Impl_", methodName : "field"});
		}
		return _g[0];
	}
}
...
$hx_exports["borogove"]["FormField"] = borogove_FormField;
...
$hx_exports["borogove"]["FormSection"] = borogove_FormSection;
...
class borogove_FormItem {
	constructor(text,field,section) {
		this.text = text;
		this.field = field;
		this.section = section;
	}
}
$hx_exports["borogove"]["FormItem"] = borogove_FormItem;
...
class borogove_FormSubmitBuilder {
	...
	submit(form) {
		...
		while(_g < _g1.length) {
			...
			++_g;
			let tmp = f.attr["var"];
			if(!this.data.has(tmp != null ? tmp : "") && borogove_Field.get_value(f).length > 0) {
				let tmp = f.attr["var"];
				...
				if(f.getChild("required") != null) {
					let tmp1 = f.attr["var"];
					if(this.data.has(tmp1 != null ? tmp1 : "")) {
						let tmp1 = f.attr["var"];
				...
				if(tmp) {
					let tmp = f.attr["var"];
					haxe_Log.trace("No value provided for required field",{ fileName : "borogove/Form.hx", lineNumber : 64, className : "borogove.FormSubmitBuilder", methodName : "submit", customParams : [tmp != null ? tmp : ""]});
					return null;
				}
			}
		}
...
$hx_exports["borogove"]["Form"] = borogove_Form;
	...
	fetchNext() {
		...
		let eventToken = this.stream.on("message",function(event) {
			...
			if(originalMessage.hasChild("encrypted",borogove_NS.OMEMO)) {
				...
				haxe_Log.trace("MAM: Processing non-OMEMO message from " + originalMessage.attr["from"],{ fileName : "borogove/MessageSync.hx", lineNumber : 146, className : "borogove.MessageSync", methodName : "fetchNext"});
		...
		query.onFinished(function() {
			...
			if(result == null) {
				haxe_Log.trace("Error from MAM, stopping sync",{ fileName : "borogove/MessageSync.hx", lineNumber : 165, className : "borogove.MessageSync", methodName : "fetchNext"});
...
class borogove_Register {
	...
	getForm() {
		...
		return thenshim_Promise.then(this.stream.register(this.domain,this.preAuth),function(reply) {
			let error = _gthis.getError(reply);
			if(error != null) {
				return thenshim_Promise.reject(error);
			}
			let form = reply.getChild("query","jabber:iq:register").getChild("x","jabber:x:data");
			if(form == null) {
			...
			_gthis.form = new borogove_Form(form);
			return thenshim_Promise.resolve(_gthis.form);
		});
	}
	submit(data) {
		let _gthis = this;
	...
	getError(iq) {
		if(iq.attr["type"] == "error") {
			let error = iq.getChild("error");
			let text = error.getChildText("text","urn:ietf:params:xml:ns:xmpp-stanzas");
			let tmp;
			if(text != null) {
				tmp = text;
			} else {
				let tmp1 = error.getFirstChild();
				tmp = tmp1 != null ? tmp1.name : null;
			}
			if(tmp != null) {
				return tmp;
			} else {
...
$hx_exports["borogove"]["Register"] = borogove_Register;
		...
		this.setupPeerConnection(function() {
			...
			if(_gthis.afterMedia == null) {
				thenshim_PromiseTools.catch_(_gthis.onPeerConnection(),function(e) {
					haxe_Log.trace("supplyMedia error",{ fileName : "borogove/calls/Session.hx", lineNumber : 593, className : "borogove.calls.InitiatedSession", methodName : "supplyMedia", customParams : [e == null ? "null" : Std.string(e)]});
					_gthis.pc.close();
				});
			} else {
				_gthis.afterMedia();
	...
	setupPeerConnection(callback) {
		...
		this.client.getIceServers(function(servers) {
			...
			_gthis.pc.addEventListener("negotiationneeded",function(event) {
				haxe_Log.trace("renegotiate",{ fileName : "borogove/calls/Session.hx", lineNumber : 612, className : "borogove.calls.InitiatedSession", methodName : "setupPeerConnection", customParams : [event]});
			});
...
class borogove_streams_XmppJsStream extends borogove_GenericStream {
	...
	register(domain,preAuth) {
		...
		return new Promise(function(resolve,reject) {
			...
			let entity1 = entity;
			let tmp = new borogove_streams_XmppJsTcp({ entity : entity});
			let tmp1 = new borogove_streams_XmppJsWebsocket({ entity : entity});
			let middleware1 = middleware;
			let streamFeatures1 = streamFeatures;
			let tmp2 = new borogove_streams_XmppJsResolve({ entity : entity});
			_gthis.client = Object.assign(entity1,tmp,tmp1,middleware1,streamFeatures1,tmp2,new borogove_streams_XmppJsSTARTTLS({ streamFeatures : streamFeatures}));
...
class tink_http_UploadedFile {
	static ofBlob(name,type,data) {
		return { fileName : name, mimeType : type, size : data.length, read : function() {
			...
			let dest = tink_io_nodejs_NodejsSink.wrap("File sink " + path,js_node_Fs.createWriteStream(path));
...
borogove_Version.HUMAN = "6ef0bd8";
...
//# sourceMappingURL=borogove.js.map