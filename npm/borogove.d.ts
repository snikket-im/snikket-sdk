...
export class borogove_calls_OutgoingProposedSession implements borogove_calls_Session {
	protected constructor(client: borogove_Client, to: borogove_JID);
	hangup(): void;
	accept(): void;
...
export class borogove_Chat {
	protected constructor(client: borogove_Client, stream: borogove_GenericStream, persistence: borogove_Persistence, chatId: string, uiState?: borogove_UiState, isBlocked?: boolean, extensions?: borogove_Stanza | null, readUpToId?: string | null, readUpToBy?: string | null, omemoContactDeviceIDs?: number[] | null);
	/**
	 * ID of this Chat
	 */
	 ...
	 */
	startCall(audio: boolean, video: boolean): borogove_calls_OutgoingProposedSession;
...
export class borogove_Channel extends borogove_Chat {
	protected constructor(client: borogove_Client, stream: borogove_GenericStream, persistence: borogove_Persistence, chatId: string, uiState?: borogove_UiState, isBlocked?: boolean, extensions?: borogove_Stanza | null, readUpToId?: string | null, readUpToBy?: string | null, disco?: borogove_Caps | null);
	getDisplayName(): string;
	description(): string;
...
export class borogove_EncryptionInfo {
	constructor(status: borogove_EncryptionStatus, method: string, methodName?: string | null, reason?: string | null, reasonText?: string | null);
	status: borogove_EncryptionStatus;
	method: string;
	methodName: string | null;
	reason: string | null;
	reasonText: string | null;
	toXml(): borogove_Stanza;
	static fromStanza(stanza: borogove_Stanza): borogove_EncryptionInfo | null;
}

export class borogove_ChatMessage {
	protected constructor(params: {attachments?: borogove_ChatAttachment[] | null, direction?: borogove_MessageDirection | null, encryption?: borogove_EncryptionInfo | null, from: borogove_JID, lang?: string | null, localId?: string | null, payloads?: borogove_Stanza[] | null, reactions?: Map<string,borogove_Reaction[]> | null, recipients?: borogove_JID[] | null, replyId?: string | null, replyTo?: borogove_JID[] | null, replyToMessage?: borogove_ChatMessage | null, senderId: string, serverId?: string | null, serverIdBy?: string | null, stanza?: borogove_Stanza | null, status?: borogove_MessageStatus | null, statusText?: string | null, syncPoint?: boolean | null, text?: string | null, threadId?: string | null, timestamp: string, to: borogove_JID, type?: borogove_MessageType | null, versions?: borogove_ChatMessage[] | null});
	/**
...
export class borogove_CommandSession {
	...
	forms: borogove_Form[];
	execute(action?: string | null, data?: { [key: string]: string | string[] } | Map<string,string | string[]> | FormData | null, formIdx?: number | null): Promise<borogove_CommandSession>;
}
