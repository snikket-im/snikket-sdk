...
import { borogove as enums } from "./borogove-enums";

export namespace borogove {
	export class Caps {
		constructor(node: string, identities: borogove.Identity[], features: string[], ver?: ArrayBuffer);
		node: string;
...
export namespace borogove {
	export class Chat {
		protected constructor(client: borogove.Client, stream: borogove.GenericStream, persistence: borogove.Persistence, chatId: string, uiState?: enums.UiState, isBlocked?: boolean, extensions?: borogove.Stanza, readUpToId?: string, readUpToBy?: string, omemoContactDeviceIDs?: number[]);
		/**
		 * ID of this Chat
		 */
		 ...
		 */
		getMessagesBefore(beforeId: string, beforeTime: string): Promise<borogove.ChatMessage[]>;
		/**
		 ...
		 * @returns Promise resolving to an array of ChatMessage that are found
		 */
		getMessagesAfter(afterId: string, afterTime: string): Promise<borogove.ChatMessage[]>;
		/**
		 ...
		 * @returns Promise resolving to an array of ChatMessage that are found
		 */
		getMessagesAround(aroundId: string, aroundTime: string): Promise<borogove.ChatMessage[]>;
		/**
		 ...
		 */
		block(reportSpam?: borogove.ChatMessage, onServer?: boolean): void;
		/**
...
export namespace borogove {
	export class Channel extends borogove.Chat {
		protected constructor(client: borogove.Client, stream: borogove.GenericStream, persistence: borogove.Persistence, chatId: string, uiState?: enums.UiState, isBlocked?: boolean, extensions?: borogove.Stanza, readUpToId?: string, readUpToBy?: string, disco?: borogove.Caps);
...
export namespace borogove {
	export class AvailableChat {
		protected constructor(chatId: string, displayName: string, note: string, caps: borogove.Caps);
		/**
...
export namespace borogove {
	export class SerializedChat {
		constructor(chatId: string, trusted: boolean, avatarSha1: ArrayBuffer, presence: Map<string,borogove.Presence>, displayName: string, uiState: enums.UiState, isBlocked: boolean, extensions: string, readUpToId: string, readUpToBy: string, notificationsFiltered: boolean, notifyMention: boolean, notifyReply: boolean, disco: borogove.Caps, omemoContactDeviceIDs: number[], klass: string);
		chatId: string;
		trusted: boolean;
...
export namespace borogove {
	export class ChatAttachment {
		constructor(name: string, mime: string, size: number, uris: string[], hashes: borogove.Hash[]);
		/**
		 * Filename
		 */
		name: string;
...
export namespace borogove {
	export class EncryptionInfo {
		constructor(status: enums.EncryptionStatus, method: string, methodName?: string, reason?: string, reasonText?: string);
		...
		static fromStanza(stanza: borogove.Stanza): borogove.EncryptionInfo;
	}
}

export namespace borogove {
	export class ChatMessage {
		protected constructor(params: {attachments?: borogove.ChatAttachment[], direction?: enums.MessageDirection, encryption?: borogove.EncryptionInfo, from: borogove.JID, lang?: string, localId?: string, payloads?: borogove.Stanza[], reactions?: Map<string,borogove.Reaction[]>, recipients?: borogove.JID[], replyId?: string, replyTo?: borogove.JID[], replyToMessage?: borogove.ChatMessage, senderId: string, serverId?: string, serverIdBy?: string, stanza?: borogove.Stanza, status?: enums.MessageStatus, syncPoint?: boolean, text?: string, threadId?: string, timestamp: string, to: borogove.JID, type?: enums.MessageType, versions?: borogove.ChatMessage[]});
		/**
		 ...
		 */
		readonly replyToMessage: borogove.ChatMessage;
		/**
		 ...
		 * this message.
		 */
		encryption: borogove.EncryptionInfo;
		/**
...
export namespace borogove {
	export class ChatMessageBuilder {
		 ...
		 */
		constructor(params?: {attachments?: borogove.ChatAttachment[], direction?: enums.MessageDirection, encryption?: borogove.EncryptionInfo, html?: string, lang?: string, localId?: string, payloads?: borogove.Stanza[], reactions?: Map<string,borogove.Reaction[]>, replyId?: string, replyToMessage?: borogove.ChatMessage, senderId?: string, serverId?: string, serverIdBy?: string, status?: enums.MessageStatus, syncPoint?: boolean, text?: string, threadId?: string, timestamp?: string, type?: enums.MessageType, versions?: borogove.ChatMessage[]});
		/**
		 * The ID as set by the creator of this message
		 */
		localId: string;
		 ...
		 * Message this one is in reply to, or NULL
		 */
		replyToMessage: borogove.ChatMessage;
		/**
		 * ID of the thread this message is in, or NULL
		 */
		threadId: string;
...
export namespace borogove {
	export class EventHandler {
		constructor(handlers: borogove.EventHandler[], callback: (arg0: any) => any, onlyOnce?: boolean);
		call(data: any): any;
		once(): borogove.EventHandler;
		unsubscribe(): void;
	}
}
...
export namespace borogove {
	export class EventEmitter {
		...
		once(eventName: string, callback: (arg0: any) => any): borogove.EventHandler;
...
export namespace borogove.calls {
	export class Media {
		...
		getUfragPwd(sessionAttributes?: borogove.calls.Attribute[]): {pwd: string, ufrag: string};
		toTransportElement(sessionAttributes: borogove.calls.Attribute[]): borogove.Stanza;
		static fromElement(content: borogove.Stanza, initiator: boolean, hasGroup: boolean, existingDescription?: borogove.calls.SessionDescription): borogove.calls.Media;
	}
}
...
export namespace borogove.calls {
	export class SessionDescription {
		...
		getFingerprint(): borogove.calls.Attribute;
		getDtlsSetup(): string;
		...
		static fromStanza(iq: borogove.Stanza, initiator: boolean, existingDescription?: borogove.calls.SessionDescription): borogove.calls.SessionDescription;
	}
}

export namespace borogove.calls {
	export class InitiatedSession implements borogove.calls.Session {
		protected constructor(client: borogove.Client, counterpart: borogove.JID, sid: string, remoteDescription: borogove.calls.SessionDescription);
		get_sid(): string;
		get_chatId(): string;
		accept(): void;
		hangup(): void;
...
export namespace borogove {
	export class Client extends borogove.EventEmitter {
		 ...
		 */
		prepareAttachment(source: File): Promise<borogove.ChatAttachment>;
		/**
		 ...
		 */
		findAvailableChats(q: string, callback: (arg0: string, arg1: borogove.AvailableChat[]) => void): void;
		/**
		 ...
		 */
		getChat(chatId: string): borogove.Chat;
		subscribePush(reg: ServiceWorkerRegistration, push_service: string, vapid_key: {privateKey: CryptoKey, publicKey: CryptoKey}, grace?: number): void;
		/**
		 ...
		 */
		enablePush(push_service: string, endpoint: string, p256dh: ArrayBuffer, auth: ArrayBuffer, grace: number, vapid_private_pkcs8?: ArrayBuffer, claims?: string[]): void;
		/**
		 ...
		 */
		addPasswordNeededListener(handler: (arg0: borogove.Client) => void): void;
		/**
		 ...
		 */
		addTlsCheckListener(handler: (arg0: string, arg1: string[]) => boolean): void;
		 ...
		 */
		addChatMessageListener(handler: (arg0: borogove.ChatMessage, arg1: enums.ChatMessageEvent) => void): void;
		/**
		 ...
		 */
		addSyncMessageListener(handler: (arg0: borogove.ChatMessage) => void): void;
		addChatsUpdatedListener(handler: (arg0: borogove.Chat[]) => void): void;
		/**
		 * Event fired when a new call comes in
		 * @param handler takes one argument, the call Session
		 */
		addCallRingListener(handler: (arg0: borogove.calls.Session) => void): void;
		/**
		 * Event fired when a call is retracted or hung up
		 * @param handler takes two arguments, the associated Chat ID and Session ID
		 */
		addCallRetractListener(handler: (arg0: string, arg1: string) => void): void;
		/**
		 * Event fired when an outgoing call starts ringing
		 * @param handler takes two arguments, the associated Chat ID and Session ID
		 */
		addCallRingingListener(handler: (arg0: string, arg1: string) => void): void;
		/**
		 ...
		 */
		addCallUpdateStatusListener(handler: (arg0: borogove.calls.InitiatedSession) => void): void;
		/**
		 ...
		 */
		addCallMediaListener(handler: (arg0: borogove.calls.InitiatedSession, arg1: boolean, arg2: boolean) => void): void;
		/**
...
export namespace borogove {
	export class Hash {
		 ...
		 */
		static fromHex(algorithm: string, hash: string): borogove.Hash;
		/**
		 * Create a new Hash from a ni:, cid: or similar URI
		 * @param uri The URI
		 * @returns Hash or null on error
		 */
		static fromUri(uri: string): borogove.Hash;
	}
}
...
export namespace borogove {
	export class JID {
		constructor(node: string, domain: string, resource?: string, raw?: boolean);
		node: string;
		domain: string;
		resource: string;
		asBare(): borogove.JID;
...
export namespace borogove {
	export class Notification {
		protected constructor(title: string, body: string, accountId: string, chatId: string, senderId: string, messageId: string, type: enums.MessageType, callStatus: string, callSid: string, imageUri: string, lang: string, timestamp: string);
		/**
		 * The title
		 */
		title: string;
...
export namespace borogove {
	export class Presence {
		constructor(caps: borogove.Caps, mucUser: borogove.Stanza);
		caps: borogove.Caps;
		mucUser: borogove.Stanza;
	}
}
...
export namespace borogove {
	export class Push {
		 ...
		 */
		static receive(data: string, persistence: borogove.Persistence): borogove.Notification;
	}
}

export namespace borogove {
	export class Reaction {
		protected constructor(senderId: string, timestamp: string, text: string, envelopeId?: string, key?: string);
		/**
...
export namespace borogove {
	export class CustomEmojiReaction extends borogove.Reaction {
		protected constructor(senderId: string, timestamp: string, text: string, uri: string, envelopeId?: string);
		uri: string;
		render<T>(forText: (arg0: string) => T, forImage: (arg0: string, arg1: string) => T): T;
		/**
...
export namespace borogove {
	export class ReactionUpdate {
		constructor(updateId: string, serverId: string, serverIdBy: string, localId: string, chatId: string, senderId: string, timestamp: string, reactions: borogove.Reaction[], kind: enums.ReactionUpdateKind);
		updateId: string;
		serverId: string;
		serverIdBy: string;
		localId: string;
		...
		getReactions(existingReactions: borogove.Reaction[]): borogove.Reaction[];
	}
}
...
export namespace borogove {
	export class Stanza implements borogove._Stanza.NodeInterface {
		...
		serialize(): string;
		toString(): string;
		tag(name: string, attr?: { [key: string]: string }): borogove.Stanza;
		text(content: string): borogove.Stanza;
		textTag(tagName: string, textContent: string, attr?: { [key: string]: string }): borogove.Stanza;
		up(): borogove.Stanza;
		...
		allTags(name?: string, xmlns?: string): borogove.Stanza[];
		allText(): string[];
		getFirstChild(): borogove.Stanza;
		getChildren(): borogove._Stanza.NodeInterface[];
		getChild(name?: string, xmlns?: string): borogove.Stanza;
		getChildText(name?: string, xmlns?: string): string;
		hasChild(name?: string, xmlns?: string): boolean;
		getText(): string;
...
export namespace borogove {
	export interface Persistence {
		lastId(accountId: string, chatId: string): Promise<string>;
		...
		storeReaction(accountId: string, update: borogove.ReactionUpdate): Promise<borogove.ChatMessage>;
		...
		getMessage(accountId: string, chatId: string, serverId: string, localId: string): Promise<borogove.ChatMessage>;
		getMessagesBefore(accountId: string, chatId: string, beforeId: string, beforeTime: string): Promise<borogove.ChatMessage[]>;
		getMessagesAfter(accountId: string, chatId: string, afterId: string, afterTime: string): Promise<borogove.ChatMessage[]>;
		getMessagesAround(accountId: string, chatId: string, aroundId: string, aroundTime: string): Promise<borogove.ChatMessage[]>;
		...
		getLogin(login: string): Promise<{clientId: string, displayName: string, fastCount: number, token: string}>;
		removeAccount(accountId: string, completely: boolean): void;
		listAccounts(): Promise<string[]>;
		storeStreamManagement(accountId: string, data: ArrayBuffer): void;
		getStreamManagement(accountId: string): Promise<ArrayBuffer>;
		storeService(accountId: string, serviceId: string, name: string, node: string, caps: borogove.Caps): void;
		findServicesWithFeature(accountId: string, feature: string): Promise<{caps: borogove.Caps, name: string, node: string, serviceId: string}[]>;
	}
}
...
export namespace borogove.persistence {
	export class Sqlite implements borogove.persistence.KeyValueStore, borogove.Persistence {
		...
		getLogin(accountId: string): Promise<{clientId: string, displayName: string, fastCount: number, token: string}>;
		/**
