...
export namespace borogove {
	export class Caps {
		constructor(node: string, identities: borogove.Identity[], features: string[], data: borogove.Stanza[], ver?: ArrayBuffer | null);
		node: string;
		identities: borogove.Identity[];
		features: string[];
		data: borogove.Stanza[];
...
export namespace haxe.io {
	export class Bytes {
		 ...
		 */
		static ofString(s: string, encoding?: any | null): haxe.io.Bytes;
		/**
...
export namespace borogove {
	export class Identity {
		...
		ver(): string;
		writeTo(out: haxe.io.Output): void;
	}
}
...
export namespace borogove {
	export class GenericStream extends borogove.EventEmitter {
		...
		register(domain: string, preAuth: string | null): Promise<borogove.Stanza>;
...
export namespace borogove {
	export class FormField {
		protected constructor(field: borogove.Stanza);
		name: string;
		label: string | null;
		value: string[];
		required: boolean;
...
export namespace borogove {
	export class Form implements borogove.FormSection {
		protected constructor(form: borogove.Stanza);
		title(): string | null;
		items(): borogove.FormItem[];
	}
}
...
export namespace borogove {
	export class Register {
		 ...
		 */
		getForm(): Promise<borogove.Form | null>;
		/**
		 ...
		 */
		static fromDomainOrInvite(domainOrInvite: string): Promise<borogove.Register>;
	}
}
